	    ...
	    _createClass(ViaMichelinMap, [{
	        ...
	        value: function render(callback) {
	            ...
	            vmService.mapInstance(this.domId, this.options.map, function (map) {
	                ...
	                var zoom = _this.options.map.zoom || 16;
	        ...
	        value: function load(callback, loadingMask) {
	            ...
	            if (window.VMLaunch) {
	                ...
	                domUtils.addResources(this.domElement, [domUtils.createScript('//secure-apijs.viamichelin.com/apijsv2/api/js?key=' + this.apiKey + '&lang=' + this.locale + '&protocol=https')], function () {
	                    Marker = __webpack_require__(26);
	                    markerClusterer = __webpack_require__(27);
	                    vmService = __webpack_require__(28);
	                    callback();
	                });
	            }
	        }
	        ...
	        value: function getDirections(origin, destination, options, callback) {
	            if (!directionsService) {
	                DirectionsService = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objectAssign = __webpack_require__(6);
	var vmService = __webpack_require__(28);
