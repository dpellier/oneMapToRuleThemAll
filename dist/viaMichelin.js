	...
	var ViaMichelinMap = (function (_Map) {
	    ...
	    _createClass(ViaMichelinMap, [{
	        ...
	        value: function render() {
	            ...
	            vmService.mapInstance(this.domId, this.options.map, function (map) {
	                ...
	                self.points.forEach(function (point) {
	                    _this.addPoint(point, {}, self.options.activeInfoWindow);
	        ...
	        value: function addPoint(point) {
	            ...
	            var activeInfoWindow = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];

	            var options = Object.assign({}, this.options.marker, customOptions);

	            if (this.map) {
	                var marker = new Marker(point, options, activeInfoWindow);
