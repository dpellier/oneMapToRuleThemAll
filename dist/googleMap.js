	    ...
	    _createClass(GoogleMap, [{
	        ...
	        value: function render() {
	            ...
	            this.points.forEach(function (point) {
	                ...
	                if (_this.options.infoWindow.active) {
	                    google.maps.event.addListener(marker, 'click', function () {
	                        infoWindow.setContent(_this.options.infoWindow.content);
	            ...
	            if (this.options.markerCluster.active) {
	                var markerClusterer = new MarkerClusterer(map, markers, this.options.markerCluster);
	            }
	        }
	    }, {
	        key: 'load',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfoWindow = (function (_google$maps$InfoWindow) {
	    function InfoWindow(options) {
	        ...
	        _get(Object.getPrototypeOf(InfoWindow.prototype), 'constructor', this).call(this, objectAssign({}, options, getContent(options.content)));
	    }
	    ...
	    _createClass(InfoWindow, [{
	        ...
	        value: function setContent(content) {
	            _get(Object.getPrototypeOf(InfoWindow.prototype), 'setContent', this).call(this, getContent(content));
	        }
	    }]);
