...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoogleMap = (function (_Map) {
	    ...
	    _createClass(GoogleMap, [{
	        ...
	        key: 'getDirections',
	        value: function getDirections(origin, destination, callback) {
	            if (!this.directionsService) {
	                var DirectionsService = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DirectionsService = (function (_google$maps$DirectionsService) {
	    ...
	    _createClass(DirectionsService, [{
	        ...
	        key: 'getRouteWithMap',
	        value: function getRouteWithMap(map, origin, destination, callback) {
	            this.getRoute(origin, destination, function (result) {
