...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarkerClusterer = __webpack_require__(9);
	...
	var GoogleMap = (function (_Map) {
	    ...
	    _createClass(GoogleMap, [{
	        ...
	        value: function render() {
	            ...
	            var InfoWindow = __webpack_require__(10);
	            var Marker = __webpack_require__(11);
	        ...
	        value: function getDirections(origin, destination, options, callback) {
	            var DirectionsService = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DirectionsService = (function (_google$maps$DirectionsService) {
	    function DirectionsService(origin, destination, options, callback) {
	    ...
	    _createClass(DirectionsService, [{
	        key: 'requestRoute',
	        value: function requestRoute(callback) {
	            this.route(this.request, function (result, status) {
	        ...
	        value: function getRouteWithMap(map) {
	            ...
	            this.requestRoute(function (result) {
	                ...
	                _this.callback(result.routes[0]); // TODO format this to be the same between all providers
	            });
	        }
	    }]);
