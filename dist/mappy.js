	...
	var Mappy = (function (_Map) {
	    ...
	    _createClass(Mappy, [{
	        ...
	        value: function getDirections(origin, destination, options, callback, onError) {
	            var DirectionsService = __webpack_require__(24);
	    ...
	    _createClass(Marker, [{
	        ...
	        value: function bindPopup(content, data) {
	            if (typeof content === 'string') {
	                _get(Object.getPrototypeOf(Marker.prototype), 'bindPopup', this).call(this, content);
	                return;
	            }

	            if (typeof content === 'function') {
	                _get(Object.getPrototypeOf(Marker.prototype), 'bindPopup', this).call(this, content(data));
	            }
	        }
	    }]);
