	...
	var Mappy = (function (_Map) {
	    ...
	    _createClass(Mappy, [{
	        ...
	        value: function load(callback, loadingMask) {
	            ...
	            domUtils.addResources(document.body, [domUtils.createScript('//cdnjs.cloudflare.com/ajax/libs/leaflet/1.0.1/leaflet.js'), domUtils.createStyle('//cdnjs.cloudflare.com/ajax/libs/leaflet/1.0.1/leaflet.css')], function () {
	                var resources = [domUtils.createScript('//d11lbkprc85eyb.cloudfront.net/Mappy/5.4.1/L.Mappy.js'), domUtils.createStyle('//d11lbkprc85eyb.cloudfront.net/Mappy/5.4.1/L.Mappy.css')];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Icon = (function (_L$DivIcon) {
	    ...
	    function Icon(point, options) {
	        ...
	        _get(Object.getPrototypeOf(Icon.prototype), 'constructor', this).call(this, objectAssign({}, options, {
